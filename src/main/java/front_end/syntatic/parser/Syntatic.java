...
public class Syntatic {
    ...
    public static void parse(List<Token> table) throws RuntimeException {
        ...
        try {
            for (int i = 0; i < GrammaticalTable.declaration.length; i++) {
                /**
                 * É importante notar que, para fins didáticos, foi utilizado uma gramática de Buckus simples
            ...
            System.out.println("Sintáxe inválida.");
            throw e;
        }
